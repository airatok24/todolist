...
urlpatterns = [
    ...
    path("board/list", views.BoardListView.as_view(), name='cat-board'),
    path("board/<pk>", views.BoardView.as_view(), name='cat-board'),
    ...
    path("goal_comment/list", views.GoalCommentListView.as_view(), name='goal-comment'),
    path("goal_comment/<pk>", views.GoalCommentView.as_view(), name='goal-comment'),
