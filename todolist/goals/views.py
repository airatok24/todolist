...
from goals.permissions import BoardPermission, GoalCategoryPermissions, IsOwnerOrReadOnly, GoalPermissions, \
    CommentsPermissions
...
class GoalCommentListView(ListAPIView):
    ...
    filterset_fileds = ['goal']
    ordering = ["-created"]

    def get_queryset(self):
        return GoalComment.objects.select_ralated('goal__category__board', 'user').filter(
            goal__category__board__particioants__user_id=self.request.user.id
        )
